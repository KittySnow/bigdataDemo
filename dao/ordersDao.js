...
module.exports = {
    add: function (req, res, next) {
        ...
        pool.getConnection(function(err, connection) {
            ...
            // 建立连接，向表中插入值
            connection.query($sql.insert, [param.orderid,+new Date(),1,param.orderFromDate,param.orderEndDate,param.roomid], function(err, result) {
    ...
    queryAll: function (req, res, next) {
        pool.getConnection(function(err, connection) {
            connection.query($sql.queryAll, function(err, result) {
                ...
                res.render('orders/list', {list: result});
            });
        });
    },
